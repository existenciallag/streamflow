...
CLINICAL = {
    'en': {
        ...
        'admission_protocol': 'Admission Protocol',
        'admission_protocol_help': 'Hospital admission protocol number',
        'initials': 'Initials',
        'date_of_birth': 'Date of Birth',
        'age': 'Age',
        'sex': 'Sex',
        'requesting_physician': 'Requesting Physician',
        'requesting_physician_help': 'Physician who requested the test',
    ...
    'es': {
        ...
        'admission_protocol': 'Protocolo de Ingreso',
        'admission_protocol_help': 'Número de protocolo de ingreso hospitalario',
        'initials': 'Iniciales',
        'date_of_birth': 'Fecha de Nacimiento',
        'age': 'Edad',
        'sex': 'Sexo',
        'requesting_physician': 'Médico Solicitante',
        'requesting_physician_help': 'Médico que solicitó el examen',
        'requesting_institution': 'Institución Solicitante',
        'notes': 'Notas',
...
PANELS = {
    'en': {
        ...
        'modify': 'Modify',
        'delete': 'Delete',
        'cost_calculated': 'Calculated dynamically from current cheapest stock',
        'cost_incomplete': 'incomplete (some reagents unavailable)',
        'no_cost': 'Cost not available'
    },
    'es': {
        'title': 'Paneles',
        ...
        'modify': 'Modificar',
        'delete': 'Eliminar',
        'cost_calculated': 'Calculado dinámicamente del stock más económico actual',
        'cost_incomplete': 'incompleto (algunos reactivos no disponibles)',
        'no_cost': 'Costo no disponible'
    }
}
